...
@section('page-title', 'Create Meeting Agenda')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4>Create Meeting Agenda Item</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('committee.agendas.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('order_index') is-invalid @enderror" 
                                           id="order_index" name="order_index" value="{{ old('order_index', 1) }}" min="1" required>
                                    @error('order_index')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>Create Agenda Item
                            </button>
                        </div>
                    </form>
                </div>
