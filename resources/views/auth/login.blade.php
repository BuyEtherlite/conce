        ...
        <div class="login-card">
            <div class="login-header">
                <div class="logo-container">
                    ...
                    <h1 class="brand-title">Council ERP</h1>
                    <p class="brand-subtitle">Municipal Management System</p>
                </div>
            </div>

            <div class="login-form-container">
                <h2 class="form-title">Department Staff Login</h2>
                <p class="form-subtitle">Access your departmental dashboard</p>
                ...
                <div class="admin-login-notice">
                    <p class="text-center mt-4">
                        <small class="text-muted">
                            ...
                            This login is for department staff only. 
                            <br>
                            <strong>Administrators:</strong> Please use the 
                            <a href="{{ route('council-admin.dashboard') }}" class="admin-link">Council Admin Portal</a>
                        </small>
                    </p>
                </div>
            </div>
