...
class BusinessIntelligenceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.businessintelligence.index')
            ->with('success', 'BusinessIntelligenceController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.businessintelligence.index')
            ->with('success', 'BusinessIntelligenceController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.businessintelligence.index')
            ->with('success', 'BusinessIntelligenceController deleted successfully.');
    }
}
