...
class IpsasReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.ipsasreport.index')
            ->with('success', 'IpsasReportController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.ipsasreport.index')
            ->with('success', 'IpsasReportController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.ipsasreport.index')
            ->with('success', 'IpsasReportController deleted successfully.');
    }
}
