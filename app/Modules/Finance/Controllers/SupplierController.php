...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.supplier.index')
            ->with('success', 'SupplierController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.supplier.index')
            ->with('success', 'SupplierController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.supplier.index')
            ->with('success', 'SupplierController deleted successfully.');
    }
}
