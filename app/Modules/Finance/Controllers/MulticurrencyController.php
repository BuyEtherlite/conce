...
class MulticurrencyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.multicurrency.index')
            ->with('success', 'MulticurrencyController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.multicurrency.index')
            ->with('success', 'MulticurrencyController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.multicurrency.index')
            ->with('success', 'MulticurrencyController deleted successfully.');
    }
}
