...
class FiscalizationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.fiscalization.index')
            ->with('success', 'FiscalizationController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.fiscalization.index')
            ->with('success', 'FiscalizationController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.fiscalization.index')
            ->with('success', 'FiscalizationController deleted successfully.');
    }
}
