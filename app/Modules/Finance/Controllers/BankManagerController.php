...
class BankManagerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.bankmanager.index')
            ->with('success', 'BankManagerController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.bankmanager.index')
            ->with('success', 'BankManagerController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.bankmanager.index')
            ->with('success', 'BankManagerController deleted successfully.');
    }
}
