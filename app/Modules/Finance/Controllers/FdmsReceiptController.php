...
class FdmsReceiptController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.fdmsreceipt.index')
            ->with('success', 'FdmsReceiptController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.fdmsreceipt.index')
            ->with('success', 'FdmsReceiptController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.fdmsreceipt.index')
            ->with('success', 'FdmsReceiptController deleted successfully.');
    }
}
