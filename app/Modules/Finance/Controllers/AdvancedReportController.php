...
class AdvancedReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.advancedreport.index')
            ->with('success', 'AdvancedReportController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.advancedreport.index')
            ->with('success', 'AdvancedReportController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.advancedreport.index')
            ->with('success', 'AdvancedReportController deleted successfully.');
    }
}
