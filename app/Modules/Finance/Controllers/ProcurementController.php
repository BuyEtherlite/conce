...
class ProcurementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.procurement.index')
            ->with('success', 'ProcurementController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.procurement.index')
            ->with('success', 'ProcurementController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.procurement.index')
            ->with('success', 'ProcurementController deleted successfully.');
    }
}
