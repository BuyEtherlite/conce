...
class ProgramReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('finance.programreport.index')
            ->with('success', 'ProgramReportController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('finance.programreport.index')
            ->with('success', 'ProgramReportController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('finance.programreport.index')
            ->with('success', 'ProgramReportController deleted successfully.');
    }
}
