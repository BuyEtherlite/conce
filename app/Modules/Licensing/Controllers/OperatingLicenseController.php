...
class OperatingLicenseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('licensing.operatinglicense.index')
            ->with('success', 'OperatingLicenseController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('licensing.operatinglicense.index')
            ->with('success', 'OperatingLicenseController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('licensing.operatinglicense.index')
            ->with('success', 'OperatingLicenseController deleted successfully.');
    }
}
