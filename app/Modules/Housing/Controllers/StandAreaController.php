...
class StandAreaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('housing.standarea.index')
            ->with('success', 'StandAreaController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('housing.standarea.index')
            ->with('success', 'StandAreaController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('housing.standarea.index')
            ->with('success', 'StandAreaController deleted successfully.');
    }
}
