...
class HousingApplicationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('housing.housingapplication.index')
            ->with('success', 'HousingApplicationController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('housing.housingapplication.index')
            ->with('success', 'HousingApplicationController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('housing.housingapplication.index')
            ->with('success', 'HousingApplicationController deleted successfully.');
    }
}
