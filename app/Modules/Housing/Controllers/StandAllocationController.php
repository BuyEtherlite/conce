...
class StandAllocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('housing.standallocation.index')
            ->with('success', 'StandAllocationController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('housing.standallocation.index')
            ->with('success', 'StandAllocationController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('housing.standallocation.index')
            ->with('success', 'StandAllocationController deleted successfully.');
    }
}
