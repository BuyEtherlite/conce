...
class CessionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('housing.cession.index')
            ->with('success', 'CessionController created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('housing.cession.index')
            ->with('success', 'CessionController updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('housing.cession.index')
            ->with('success', 'CessionController deleted successfully.');
    }
}
